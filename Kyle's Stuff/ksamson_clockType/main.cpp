...
int main()
{
	...
	///////////////////////////////////////////////////////
		...
		//Retrieve timezone
	yourTimeZone.getTimeZone(hours, timeZone);

        //Output the value of hours, minutes, and seconds
    cout << "Line 28: hours = " << hours 
         << ", minutes = " << minutes 
         << ", seconds = " << seconds << endl;         //Line 28
	cout << "\nTime Zone = " << yourTimeZone.getTimeZone(hours, timeZone) << endl;
	cout << "After adding/subtracting hours to myClock: ";
	myClock.printTime();
